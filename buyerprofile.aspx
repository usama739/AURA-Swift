<%@ Page Language="C#" MasterPageFile="~/AURA Swift.Master" 
    AutoEventWireup ="true" CodeBehind="buyerprofile.aspx.cs" Inherits="AURA_Swift.buyerprofile" %>
        ...
        <div class="userNav">
            ...
            <div class="sideForm">
                <div class="navContent">
                    ...
                    <asp:Button ID="hlProduct" PostBackUrl="buyerPage.aspx" runat="server" Text="My Profile" />
                    <br />
