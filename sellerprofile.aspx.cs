...
namespace AURA_Swift
{
    public partial class sellerprofile : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    found = objMyDal.insertProfile_supplier(ref Fname, ref Lname, ref userName, ref city, ref postalcode, ref Gender, ref country, ref phone, ref email, ref companyName, ref Address, ref DT);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            found = objMyDal.updateUser_supplier(ref Fname, ref Lname, ref userName, ref olduserName, ref city, ref postalcode, ref Gender, ref country, ref phone, ref email, ref companyName, ref Address, ref DT, ref email_exists, ref userName_exists);
